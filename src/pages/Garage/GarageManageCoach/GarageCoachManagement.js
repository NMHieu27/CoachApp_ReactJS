...
import './GarageCoachManagement.scss';
function GarageCoachManagement() {
    const [coachList, setCoachList] = useState();
    const currentOwnerId = localStorage.getItem('userId'); // Sau sẽ get list coach theo owner Id
    const columns = [
        { title: 'Id', field: 'id' },
        ...
        },
        {
            ...
            render: (rowData) =>
                rowData && (
                    <div>
                        <Link to={`/garage/danh-sach-xe/chinh-sua/${rowData.id}`}>
                        ...
                        <div className="card__body">
                            {coachList ? (
                                <TableCustom
                                    ...
                                    columns={columns}
                                    data={coachList}
                                    link={config.routes.garageAddCoach}
                                />
                            ) : (
                                <p>loading...</p>
                            )}
...
export default GarageCoachManagement;
