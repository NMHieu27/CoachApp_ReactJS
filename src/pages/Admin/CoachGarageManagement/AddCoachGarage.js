...
function AddCoachGarage() {
            ...
            if (!values.userId) {
                ...
                try {
                    ...
                    if (response.code === 200) {
                        ...
                        toast.error('Thêm nhà xe thất bại! ' + response.message, {
                            theme: 'colored',
                        });
                        throw new Error(response.message);
                    }
    ...
    return (
        <Helmet title="Thêm nhà xe">
            <div className="add-coach-garage">
                <div
                ...
                <div
                    className="add-coach-garage__form-add-coach-garage"
